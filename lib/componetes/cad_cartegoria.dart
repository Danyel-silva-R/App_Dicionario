...
class CadCategoria extends StatelessWidget {
  ...
  final String imagenRela;
  final VoidCallback tap; // precisa ser final, pois StatelessWidget é imutável

  const CadCategoria({
    super.key,
    required this.nomeCad,
    required this.imagenRela,
    required this.tap, // recebe como parâmetro obrigatório
  });
      ...
      child: GestureDetector(
        ...
        child: Card(
          ...
          child: Row(
            ...
            children: [
              Image.asset(imagenRela, width: 100, height: 100),
